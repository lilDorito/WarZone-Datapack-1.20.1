...
give @s superbwarfare:mosin_nagant 1
...
execute as @s[scores={temp_count=..31}] run tellraw @s {"text":"[✔] Mosin + ammo refilled","color":"green"}

execute as @s[scores={temp_count=32..}] run tellraw @s {"text":"[✔] Mosin equipped (ammo already full)","color":"yellow"}
