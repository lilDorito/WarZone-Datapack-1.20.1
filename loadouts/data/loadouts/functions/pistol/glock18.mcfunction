...
give @s superbwarfare:glock_18 1
...
execute as @s[scores={temp_count=..191}] run tellraw @s {"text":"[✔] Glock-18 + ammo refilled","color":"green"}

execute as @s[scores={temp_count=192..}] run tellraw @s {"text":"[✔] Glock-18 equipped (ammo already full)","color":"yellow"}
