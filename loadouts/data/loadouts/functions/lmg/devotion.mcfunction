...
give @s superbwarfare:devotion 1
...
execute as @s[scores={temp_count=..191}] run tellraw @s {"text":"[✔] Devotion + ammo refilled","color":"green"}

execute as @s[scores={temp_count=192..}] run tellraw @s {"text":"[✔] Devotion equipped (ammo already full)","color":"yellow"}
