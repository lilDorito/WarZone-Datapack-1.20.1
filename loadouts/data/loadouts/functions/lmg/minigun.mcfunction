...
give @s superbwarfare:minigun 1
...
execute as @s[scores={temp_count=..191}] run tellraw @s {"text":"[✔] M-134 Minigun + ammo refilled","color":"green"}

execute as @s[scores={temp_count=192..}] run tellraw @s {"text":"[✔] M-134 Minigun equipped (ammo already full)","color":"yellow"}
