...
give @s superbwarfare:ap_5_inches 32
give @s superbwarfare:he_5_inches 32
give @s mcsp:m1a2_sep_sand_spawn_item 1

tellraw @s {"text":"[✔] M1A2 Abrams (sand) loadout received!","color":"green"}
