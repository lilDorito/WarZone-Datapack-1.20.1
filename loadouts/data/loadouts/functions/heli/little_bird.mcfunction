...
give @s superbwarfare:container{BlockEntityTag:{id:"superbwarfare:container",EntityType:"superbwarfare:ah_6",Count:1b}} 1

execute store result score @s temp_count run clear @s superbwarfare:small_shell 0
execute if score @s temp_count matches ..192 run give @s superbwarfare:small_shell 64

execute store result score @s temp_count run clear @s superbwarfare:small_rocket 0
execute if score @s temp_count matches ..16 run give @s superbwarfare:small_rocket 16
