...
give @s superbwarfare:container{BlockEntityTag:{id:"superbwarfare:container",EntityType:"ashvehicle:v-22",Count:1b}} 1
...
tellraw @s {"text":"[✔] V-22 Osprey loadout received!","color":"green"}
