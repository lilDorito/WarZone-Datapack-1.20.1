...
execute as @s[scores={temp_count=..191}] run tellraw @s {"text":"[✔] MK-14 + ammo refilled","color":"green"}

execute as @s[scores={temp_count=192..}] run tellraw @s {"text":"[✔] MK-14 equipped (ammo already full)","color":"yellow"}
