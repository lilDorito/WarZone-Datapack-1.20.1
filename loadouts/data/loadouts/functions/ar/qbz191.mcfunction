...
give @s superbwarfare:qbz_191 1
...
execute as @s[scores={temp_count=..191}] run tellraw @s {"text":"[✔] QBZ-191 + ammo refilled","color":"green"}

execute as @s[scores={temp_count=192..}] run tellraw @s {"text":"[✔] QBZ-191 equipped (ammo already full)","color":"yellow"}
