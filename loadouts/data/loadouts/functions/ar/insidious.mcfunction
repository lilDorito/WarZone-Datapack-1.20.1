...
give @s superbwarfare:insidious 1
...
execute as @s[scores={temp_count=..191}] run tellraw @s {"text":"[✔] Insidious + ammo refilled","color":"green"}

execute as @s[scores={temp_count=192..}] run tellraw @s {"text":"[✔] Insidious equipped (ammo already full)","color":"yellow"}
