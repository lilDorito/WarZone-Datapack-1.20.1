...
give @s superbwarfare:container{BlockEntityTag:{id:"superbwarfare:container",EntityType:"ashvehicle:su-34",Count:1b}} 1
give @s superbwarfare:small_shell 256
give @s superbwarfare:small_rocket 32
give @s ashvehicle:aam_4_item 2
give @s superbwarfare:medium_aerial_bomb 6

tellraw @s {"text":"[✔] Su-34 Fullback loadout received!","color":"green"}
