...
give @s superbwarfare:container{BlockEntityTag:{id:"superbwarfare:container",EntityType:"ashvehicle:f-18",Count:1b}} 1
give @s superbwarfare:small_shell 256
give @s ashvehicle:aam_4_item 8

tellraw @s {"text":"[✔] F/A-18 Hornet loadout received!","color":"green"}
