...
give @s superbwarfare:container{BlockEntityTag:{id:"superbwarfare:container",EntityType:"superbwarfare:a_10a",Count:1b}} 1
give @s superbwarfare:small_shell 256
give @s superbwarfare:agm 6
give @s superbwarfare:medium_aerial_bomb 4
give @s superbwarfare:small_rocket 32

tellraw @s {"text":"[✔] A-10 Thunderbolt II loadout received!","color":"green"}
