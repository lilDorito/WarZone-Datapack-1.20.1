...
give @s superbwarfare:container{BlockEntityTag:{id:"superbwarfare:container",EntityType:"ashvehicle:reaper",Count:1b}} 1
give @s superbwarfare:medium_aerial_bomb 2
