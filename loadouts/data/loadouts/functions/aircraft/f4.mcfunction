...
give @s superbwarfare:container{BlockEntityTag:{id:"superbwarfare:container",EntityType:"ashvehicle:f_4",Count:1b}} 1
give @s superbwarfare:small_shell 256
give @s ashvehicle:aam_4_item 4

tellraw @s {"text":"[✔] F-4 Phantom II loadout received!","color":"green"}
