...
give @s superbwarfare:container{BlockEntityTag:{id:"superbwarfare:container",EntityType:"ashvehicle:su-27",Count:1b}} 1
give @s superbwarfare:small_shell 256
give @s superbwarfare:small_rocket 32
give @s ashvehicle:aam_4_item 4

tellraw @s {"text":"[✔] Su-27 Flanker loadout received!","color":"green"}
