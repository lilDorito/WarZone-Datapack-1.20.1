...
give @s superbwarfare:container{BlockEntityTag:{id:"superbwarfare:container",EntityType:"ashvehicle:f_2",Count:1b}} 1
give @s superbwarfare:small_shell 256
give @s superbwarfare:agm 5
give @s ashvehicle:aam_4_item 5

tellraw @s {"text":"[✔] F-2 Viper Zero loadout received!","color":"green"}
