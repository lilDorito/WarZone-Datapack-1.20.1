...
give @s superbwarfare:container{BlockEntityTag:{id:"superbwarfare:container",EntityType:"ashvehicle:j-20",Count:1b}} 1
give @s superbwarfare:small_shell 256
give @s ashvehicle:aam_4_item 10

tellraw @s {"text":"[✔] J-20 Mighty Dragon loadout received!","color":"green"}
