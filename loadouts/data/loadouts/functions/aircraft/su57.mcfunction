...
give @s superbwarfare:container{BlockEntityTag:{id:"superbwarfare:container",EntityType:"ashvehicle:su-57",Count:1b}} 1
give @s superbwarfare:small_shell 256
give @s superbwarfare:small_rocket 32
give @s ashvehicle:aam_4_item 8

tellraw @s {"text":"[✔] Su-57 Felon loadout received!","color":"green"}
