...
give @s superbwarfare:container{BlockEntityTag:{id:"superbwarfare:container",EntityType:"ashvehicle:mig_29",Count:1b}} 1
give @s superbwarfare:small_shell 256
give @s ashvehicle:aam_4_item 6

tellraw @s {"text":"[✔] MiG-29 Fulcrum loadout received!","color":"green"}
