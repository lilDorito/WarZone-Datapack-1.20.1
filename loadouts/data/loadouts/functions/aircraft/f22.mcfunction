...
give @s superbwarfare:container{BlockEntityTag:{id:"superbwarfare:container",EntityType:"ashvehicle:f-22",Count:1b}} 1
give @s superbwarfare:small_shell 256
give @s ashvehicle:aam_4_item 10

tellraw @s {"text":"[✔] F-22 Raptor loadout received!","color":"green"}
